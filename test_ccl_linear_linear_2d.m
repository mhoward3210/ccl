% Script to demonstrate constraint consistent learning on a 2-D linear data set using a linear model.
...
fprintf(1,'True parameter:\n w =\n'),disp(w)
fprintf(1,'Estimated parameter:\n wp =\n'),disp(model.w)
